# --- شروع اسکریپت Trend-Analyzer (نسخه نهایی ۵ - رفع باگ Await) ---
...
async def main(context):
    context.log("فانکشن Trend-Analyzer (نسخه نهایی ۵) شروع به کار کرد...")
    ...
    try:
        ...
        # --- رفع باگ نهایی ---
        # کلمه 'await' از اینجا حذف شد چون 'create_document' همزمان (sync) است
