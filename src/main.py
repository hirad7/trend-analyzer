...
async def main(context):
    ...
    try:
        ...
        # === ۳. تولید ترند (مثال – بعداً با Google Trends واقعی جایگزین کن) ===
        ...
        chat_response = requests.post(
            ...
            json={
                "model": "grok-4-latest",
                "messages": [
                    {"role": "user", "content": reportage_prompt}
                ],
                "temperature": 0.7,
                "max_tokens": 500
            }
        ...
        data = {
            ...
            'image_url': final_image_url or image_url or 'بدون عکس',
            'status': 'ready_to_publish',
            'source_url': 'https://example.com',  # بعداً واقعی کن
            'featured_media_url': 'https://example.com/video',  # بعداً
        ...
        context.log("مقاله با عکس و متن ذخیره شد.")
